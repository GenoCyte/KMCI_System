...
namespace KMCI_System.SalesModule
{
    public partial class ProjectManagement : UserControl
    {
        ...
        private void SetupDataGridView()
        {
            ...
            // Style cells
            dgvProject.DefaultCellStyle.BackColor = Color.White;  // Add this line for default rows
            ...
            dgvProject.AlternatingRowsDefaultCellStyle.BackColor = Color.FromArgb(245, 245, 245);  // Changed from (250, 250, 250) for better contrast
